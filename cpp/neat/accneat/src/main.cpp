    ...
    while ((opt = getopt(argc,
      ...
      switch (opt) {
        case 'f':
          ...
          break;
        case 'c':
          env->num_runs = parse_int("-c",
                                    optarg);
          break;
        case 'r':
          rng_seed = parse_int("-r",
                               optarg);
          break;
        case 'n':
          env->pop_size = parse_int("-n",
                                    optarg);
          break;
        case 'x':
          maxgens = parse_int("-x",
          ...
          break;
        case 's':
          env->search_type = parse_enum<GeneticSearchType>("-s",
                                                           optarg,
                                                           {
          ...
          break;
        default: error("Invalid option: -" << (char)opt);
      }
    }
  }
