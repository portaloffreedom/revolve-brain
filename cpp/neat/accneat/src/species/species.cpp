...
bool
Species::add_Organism(SpeciesOrganism *o)
{
...
void
Species::remove_generation(int gen)
{
  erase_if(organisms,
           [gen](SpeciesOrganism *org)
...
//bool
//Species::print_to_file(std::ostream &outFile)
//{
...
real_t
Species::count_offspring(real_t skim)
{
  std::vector<SpeciesOrganism *>::iterator curorg;
...
void
Species::reproduce(int ioffspring,
...
bool
NEAT::order_new_species(Species *x,
                        Species *y)
{
