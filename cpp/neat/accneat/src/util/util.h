        ...
        const std::string &delimiters = WHITESPACE)
{
  ...
  return pos == std::string::npos ? "" : s.substr(0,
                                                  pos + 1);
}
...
permute_repeat(const std::string &letters,
               size_t len);
