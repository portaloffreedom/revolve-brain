...
namespace revolve
{
  namespace brain
  {
            ...
            : public Learner<PolicyPtr>
    {
      ...
      static const size_t
              MAX_EVALUATIONS;// = 1000; // max number of evaluations
      static const size_t
              MAX_RANKED_POLICIES;// = 10; // max length of policies vector
      static const size_t
              INTERPOLATION_CACHE_SIZE;// = 100; // number of data points for the interpolation cache
      static const size_t
              INITIAL_SPLINE_SIZE;// = 3; // number of initially sampled spline points
      static const size_t
              UPDATE_STEP;// = 100; // after # generations, it increases the number of spline points
      static const double
              EVALUATION_RATE;// = 30.0; // evaluation time for each policy
      static const double
              SIGMA_START_VALUE;// = 0.8; // starting value for sigma
      ...
      size_t
              interpolation_spline_size_; // Number of 'interpolation_cache_' sample points
      ...
      size_t step_rate_; //
      size_t
              update_step_; // Number of evaluations after which sampling size increases
