...
namespace cppneat
{
  class GeneticEncoding
  {
    ...
    public:
    //non-layered
    public: std::vector<NeuronGenePtr> neuron_genes_;

    //layered
    public: std::vector<std::vector<NeuronGenePtr>> layers_;

    //both
    public: std::vector<ConnectionGenePtr> connection_genes_;

    public: bool is_layered_;

    private: std::vector<GenePtr> all_genes_sorted;

    private: bool all_genes_valid;
