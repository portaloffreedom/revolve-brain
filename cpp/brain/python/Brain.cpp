...
BOOST_PYTHON_MODULE (revolve_brain_python)
{
  ...
  boost::python::class_< python_array< double > >(
          "Array",
          boost::python::no_init).def(
          "__setitem__",
          &python_array< double >::setitem).def(
          "__getitem__",
          &python_array< double >::getitem);

  // evaluator abstract class
  boost::python::class_< EvaluatorWrap,
                         boost::noncopyable >("Evaluator").def(
          "start",
  ...
  boost::python::class_< ActuatorWrap, boost::noncopyable >("Actuator").def(
          "update",
          boost::python::pure_virtual(&Actuator::update)).def(
          "outputs",
          boost::python::pure_virtual(&Actuator::outputs));

  // sensor abstract class
  boost::python::class_< SensorWrap,
                         boost::noncopyable >("Sensor").def(
          "read",
          boost::python::pure_virtual(&Sensor::read)).def(
          "inputs",
          boost::python::pure_virtual(&Sensor::inputs)).def(
          "sensorId",
          boost::python::pure_virtual(&Sensor::sensorId));

  // abstract Brain class
  boost::python::class_< Brain, boost::noncopyable >(
          "Brain",
  ...
  boost::python::class_< RLPower_python,
                         boost::python::bases< Brain >, boost::noncopyable >(
          "RLPower",
  ...
  boost::python::class_< SUPGBrain_python,
                         ...
                         boost::noncopyable >(
          "SUPGBrain",
          boost::python::init< boost::shared_ptr< Evaluator >,
                               boost::python::list &,
                               boost::python::list &,
                               boost::python::list & >()).def(
          "update",
          &SUPGBrain_python::update);
  ...
  boost::python::class_< AsyncNeat,
          ...
          boost::python::no_init).def(
          "Init",
          static_cast<void (*)()>(&AsyncNeat::Init)).staticmethod("Init").def(
          "CleanUp",
          &AsyncNeat::CleanUp).staticmethod("CleanUp");
}
